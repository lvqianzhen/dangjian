<template>
  <div class="gerenzongjie_box">
    <tiaozhuanheader>个人总结</tiaozhuanheader>
    <div class="kong"></div>
  ...
  import tiaozhuanheader from '../../../base/tiaozhuanheader.vue'
    export default {
      ...
      methods: {
        ...
        tijiaoshenhe(){
          this.$axios.post("tijiaotupian",{pic:this.imageUrl}).then((res)=>{
        ...
        minzupingyiid(){
          this.$axios.get("minzhupingyinewsc",{status:1}).then( res => {
                // console.log(res.data)
                this.reviewId=res.data.data[0]._id
        ...
        aaa(){
          this.$axios.get("gerenxinxi").then( res => {
            ...
            this.branchId=res.data.data.branchId
